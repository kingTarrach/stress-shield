...
class RegisterViewVM: ObservableObject {
    ...
    private func validate() -> Bool {
        ...
        let specialCharacter = CharacterSet.punctuationCharacters.union(CharacterSet.symbols)
        ...
        guard password.rangeOfCharacter(from: digit) != nil else {
            errorMsg = "Password must contain at least one number."
            return false
        }
        
        guard password.rangeOfCharacter(from: specialCharacter) != nil else {
